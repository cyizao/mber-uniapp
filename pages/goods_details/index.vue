		...
		<view class="product-con">
			...
			<view>
				<scroll-view :scroll-top="scrollTop" scroll-y="true" scroll-with-animation="true"
					:style="'height:' + height + 'px;'" @scroll="scroll" :scroll-into-view="topItem">
					<view id="top"></view>
					<view id="past0">
						<!-- #ifdef APP-PLUS || MP -->
			...
			<view v-if="isShowTop">
				<backTop @backTop="handleBackTop"></backTop>
			</view>
			<!-- #ifdef H5 || APP-PLUS -->
	...
	export default {
		...
		methods: {
			...
			scroll(e) {
				...
				this.isShowTop = scrollY >= 1020 ? true : false
				if (that.lock) {
